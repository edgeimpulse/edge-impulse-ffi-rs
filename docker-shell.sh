...
echo "  cargo build --example ffi_image_infer --target aarch64-unknown-linux-gnu --release"
echo "  ./target/aarch64-unknown-linux-gnu/release/examples/ffi_image_infer --image test_image.png --debug"
echo "  cargo clean"
echo ""
